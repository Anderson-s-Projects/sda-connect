      ...
      <main className="mt-32 w-full px-6">
        <div className="max-w-7xl mx-auto">
          ...
          duration: 0.6
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Join a vibrant community of Adventists dedicated to spiritual growth and fellowship</p>
            <button onClick={handleConnect} className="px-8 py-4 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all transform hover:scale-105 inline-flex items-center gap-2">
              Connect
